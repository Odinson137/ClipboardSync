// android\app\src\main\java\com\clipboardsync\ScheduleService.kt
    ...
    private fun showNotificationIfNotPresent() {
        ...
        if (!isNotificationActive(notificationManager)) {
            val intent = Intent(applicationContext, MainActivity::class.java).apply {
                action = "com.clipboardsync.NOTIFICATION_ACTION"
            ...
            val notification = NotificationCompat.Builder(applicationContext, NOTIFICATION_CHANNEL_ID)
                ...
                .setContentTitle("ClipboardSync Service Inactive")
                .setContentText("ClipboardSync monitoring is inactive. Tap to restart.")
