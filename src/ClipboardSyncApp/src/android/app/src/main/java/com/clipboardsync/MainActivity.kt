// android\app\src\main\java\com\clipboardsync\MainActivity.kt
...
class MainActivity : ReactActivity() {
    ...
    */
    override fun getMainComponentName(): String = "ClipboardSync"
    ...
    */
    ...
    private fun handleIntent(intent: Intent) {
        ...
        if ("com.clipboardsync.NOTIFICATION_ACTION" == intent.action) {
